using TABAS_Mobile.Validators;
using TABAS_Mobile.Validators.Rules;
using Xamarin.Forms;
...
namespace TABAS_Mobile.ViewModels
{
    ...
    public class BusinessRegistrationFormPage1ViewModel : LoginViewModel
    {
        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessRegistrationFormPage1ViewModel" /> class
        /// </summary>
        public BusinessRegistrationFormPage1ViewModel()
        {
