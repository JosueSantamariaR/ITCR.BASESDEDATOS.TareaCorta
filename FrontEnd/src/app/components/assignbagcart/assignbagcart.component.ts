...
@Component({
  selector: 'app-assignbagcart',
  templateUrl: './assignbagcart.component.html',
  styleUrls: ['./assignbagcart.component.css']
})
export class AssignbagcartComponent implements OnInit {
  public citydata;
